        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">dimas abdul rohim</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  dimas abdul rohim - Web Developer
              ...
              case 'tambahdataasset':
               $this->load->view('tambah_data_asset');
                ...
                case 'edit_data_user':
                  ...
                  break;
                   case 'edit_data_investor':
                  $this->load->view('edit_data_investor');
                  break;
                  case 'edit_data_asset':
...
<script src="<?php echo base_url() ?>asset/<?php echo base_url() ?>asset/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- SlimScroll -->
